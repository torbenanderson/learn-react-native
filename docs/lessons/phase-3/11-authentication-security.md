# Lesson 11: Authentication and Security - Secure Your Budget App
...
**"React Native in Action" - Chapter 11: Authentication and Security**
- Section 11.1: Authentication concepts
- Section 11.2: JWT tokens and secure storage
- Section 11.3: Login/logout flows
- Section 11.4: Biometric authentication
...
### Preview of Lesson 12: Advanced UI Components
...
**Excellent work completing Lesson 11!** Your app is now secure and user-friendly. Tomorrow, we'll build advanced UI components!

---

**Time to complete**: ~3-4 hours
**Difficulty**: ⭐⭐⭐⭐☆ Advanced
**Previous lesson**: [10-api-integration-data-sync.md](./10-api-integration-data-sync.md)
**Next lesson**: [12-advanced-ui-components.md](./12-advanced-ui-components.md)
